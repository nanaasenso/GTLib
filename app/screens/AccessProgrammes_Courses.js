...
function AccessProgrammes_Courses() {
            ...
            <View style={styles.programmeOverviewContainer}>
              ...
              <View style={styles.courseRow}>
                <TouchableOpacity style={styles.course} activeOpacity={0.8}>
                  <CapImage />
                  <Text style={styles.courseName}>ABCE / GBCE</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.course} activeOpacity={0.8}>
                  <CapImage />
                  <Text style={styles.courseName}>
                    Diploma in Procurement & Logistics (NAPBTEX)
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.courseRow}>
                ...
                <TouchableOpacity style={styles.course} activeOpacity={0.8}>
                  <CapImage />
                  <Text style={styles.courseName}>Mature Access Course</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
...
export default AccessProgrammes_Courses;

...
function SystemsAnalysisAndDesign() {
  ...
  const fetchCourseData = async () => {
    try {
      const courseDocRef = doc(db, 'bitCourses', 'IT 221');
    ...
    <>
      ...
      >
        <View style={styles.background}>
          ...
          {materials[5] && (
            <>
              <Text style={styles.chapterHeading}>Textbook</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
...
export default SystemsAnalysisAndDesign;

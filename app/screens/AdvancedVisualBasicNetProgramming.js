...
function AdvancedVisualBasicNetProgramming() {
  ...
  const fetchCourseData = async () => {
    try {
      const courseDocRef = doc(db, 'bitCourses', 'IT 302');
    ...
    <>
      ...
      >
        <View style={styles.background}>
          ...
          {materials[0] && (
            <>
              <Text style={styles.chapterHeading}>Lecture One and Two</Text>
              <TouchableOpacity
...
export default AdvancedVisualBasicNetProgramming;

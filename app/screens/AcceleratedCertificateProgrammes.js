...
function AcceleratedCertificateProgrammes() {
            ...
            <View style={styles.programmeOverviewContainer}>
              ...
              <View style={styles.courseRow}>
                <TouchableOpacity style={styles.course} activeOpacity={0.8}>
                  <CapImage />
                  <Text style={styles.courseName}>A+ Certification</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.course} activeOpacity={0.8}>
                  <CapImage />
                  <Text style={styles.courseName}>N+ Certification</Text>
                </TouchableOpacity>
              </View>
...
export default AcceleratedCertificateProgrammes;

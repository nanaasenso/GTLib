...
function HumanResourceDevelopment() {
  ...
  const fetchCourseData = async () => {
    try {
      const courseDocRef = doc(db, 'bitCourses', 'IT 461');
    ...
    <>
      ...
      >
        <View style={styles.background}>
          ...
          {materials[0] && (
            <>
              <Text style={styles.chapterHeading}>Lecture One & Two</Text>
              <TouchableOpacity
          ...
          {materials[4] && (
            <>
              <Text style={styles.chapterHeading}>Lecture Six</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[5] && (
            <>
              <Text style={styles.chapterHeading}>Lecture Seven</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[6] && (
            <>
              <Text style={styles.chapterHeading}>Lecture Eight</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}

...
function ComputerArchitecture() {
  ...
  const fetchCourseData = async () => {
    try {
      const courseDocRef = doc(db, 'bitCourses', 'IT 231');
    ...
    <>
      ...
      >
        <View style={styles.background}>
          ...
          {materials[0] && (
            <>
              <Text style={styles.chapterHeading}>Lecture 1 and 2</Text>
              <TouchableOpacity
          ...
          {materials[1] && (
            <>
              <Text style={styles.chapterHeading}>Lecture 3 and 4</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[2] && (
            <>
              <Text style={styles.chapterHeading}>Lecture 5, 6 and 7</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[3] && (
            <>
              <Text style={styles.chapterHeading}>Lecture 8 and 9</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[4] && (
            <>
              <Text style={styles.chapterHeading}>Lecture 10, 11 and 12</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[5] && (
            <>
              <Text style={styles.chapterHeading}>Lecture 13</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[6] && (
            <>
              <Text style={styles.chapterHeading}>Lecture 14</Text>
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
          ...
          {materials[9] && (
            <>
              ...
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
                onPress={() => openMaterial(materials[9])}
              >
                <View style={styles.chapterContent}>
          ...
          {materials[10] && (
            <>
              ...
              <TouchableOpacity
                style={styles.chapterBorder}
                activeOpacity={0.6}
                onPress={() => openMaterial(materials[10])}
              >
                <View style={styles.chapterContent}>
                  <Image source={QuizIcon} style={styles.icon} />
                  <Text style={styles.learningMaterial}>

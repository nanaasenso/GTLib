...
function LegalAndEthicalUseOfInformationTechnology() {
  ...
  const fetchCourseData = async () => {
    try {
      const courseDocRef = doc(db, 'bitCourses', 'IT 451');
    ...
    <>
      ...
      >
        <View style={styles.background}>
          ...
          {materials[0] && (
            <>
              <Text style={styles.chapterHeading}>Lecture Note</Text>
              <TouchableOpacity
...
export default LegalAndEthicalUseOfInformationTechnology;

...
function BScElectricalAndElectronicEngineering() {
    ...
    <>
      ...
      >
        <View style={styles.background}>
          ...
          <View style={styles.rows}>
            <View style={styles.levelContainer}>
              <Text style={styles.level}>Level 300</Text>
            ...
            <View style={styles.levelContainer}>
              <Text style={styles.level}>Level 400</Text>
...
export default BScElectricalAndElectronicEngineering;
